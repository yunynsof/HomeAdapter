...
public class AbstractTest {
	...
	protected static HomeAdapter daAdapter;
	...
	public AbstractTest(final String jndi) throws Exception {
		...
		daAdapter = (HomeAdapter) container.getContext().lookup(
				"java:global/HomeAdapter/HomeAdapter!hn.com.tigo.josm.orchestrator.home.adapter.core.HomeAdapter");
